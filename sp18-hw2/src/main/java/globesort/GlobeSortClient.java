...
public class GlobeSortClient {
    ...
    public void run(Integer[] values) throws Exception {
        ...
        System.out.println("latency: " + latency + " Millis");
        ...
        double oneway = values.length * 1.0 / ((totalTime - duration)/ 2);
        double appThourghput = values.length*1.0 / totalTime;
        System.out.println("One-way network throughput: " + oneway + " records sorted per Millis");
        System.out.println("Application throughput is: " + appThourghput + " records sorted per Millis");
    }
